...
class CashewKernelSalesCreateRequest(BaseModel):
    sale_date: str
    ...
    shape: Optional[str]
    quantity_in_tin: Optional[int] = 0
    price_per_tin: Optional[float] = 0.0
...
class CashewKernelSalesUpdateRequest(BaseModel):
    id: int
...
class CashewKernelSalesDeleteRequest(BaseModel):
    id: int
...
class CashewKernelSalesFetchByBatchNumberRequest(BaseModel):
    batch_number: str
...
class CashewKernelSalesResponse(BaseModel):
    id: int
    sale_date: str
    bill_number: str
    customer_name: str
