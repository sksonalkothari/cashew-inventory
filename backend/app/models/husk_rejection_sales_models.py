...
class HuskRejectionSalesCreateRequest(BaseModel):
    sale_date: str
...
class HuskRejectionSalesUpdateRequest(BaseModel):
    id: int
...
class HuskRejectionSalesDeleteRequest(BaseModel):
    id: int
...
class HuskRejectionSalesFetchByBatchNumberRequest(BaseModel):
    batch_number: str
...
class HuskRejectionSalesResponse(BaseModel):
    id: int
    sale_date: str
    bill_number: str
    customer_name: str
