...
class HuskReturnCreateRequest(BaseModel):
    return_date: str
    _map_date = remap_date_field("return_date")
    batch_number: str
    ...
    @classmethod
    def validate_return_date(cls, value: str, info):
        return valid_date(value, info.field_name)


class HuskReturnUpdateRequest(BaseModel):
    id: int
...
class HuskReturnDeleteRequest(BaseModel):
    id: int
...
class HuskReturnFetchByBatchNumberRequest(BaseModel):
    batch_number: str
...
class HuskReturnResponse(BaseModel):
    id: int
    return_date: str
    batch_number: str
    wholes_kg: Optional[float]
