...
export const peelingAfterDryingPageMeta = {
  title: "Peeling After Drying Process",
  subtitle: "Add daily peeling after drying records",
  icon: <Layers fontSize="medium" sx={{ color: "#cc6600" }} />,
};
